...
// score elements
let currentScoreEl = document.querySelector('.current-score span');
let highScoreEl = document.querySelector('.high-score span');
...
function createEvents() {
    ...
    Matter.Events.on(engine, 'collisionStart', function(event) {
        event.pairs
            .filter((pair) => {
                return pair.bodyB.label === 'pinball';
            })
            .forEach((pair) => {
